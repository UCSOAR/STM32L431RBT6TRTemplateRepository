...
// OSCILLATOR LOGGING TASK
constexpr uint8_t TASK_OSCILLATOR_PRIORITY = 2;            // Priority of the oscillator task
constexpr uint8_t TASK_OSCILLATOR_QUEUE_DEPTH_OBJS = 10;        // Size of the oscillator task queue
constexpr uint16_t TASK_OSCILLATOR_STACK_DEPTH_WORDS = 512;        // Size of the oscillator task stack
